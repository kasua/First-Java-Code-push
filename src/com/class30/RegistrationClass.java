...
/*3. Create Registration Class 
 * in which you would have variables as email, userName and password
 ...
 *  
 *  Requirements:
 *  Valid email consider to be only gmailValid userName and password cannot be empty and 
