...
public class Task {
	...
	public static void main(String[] args) {
		...
		/*
		 * 1. Declare variableClassA and increase by 100 using shorthand operator 2. Declare
		 * variableClassA and decrease by 67 using shorthand operator 3. Declare variableClassA
		 * cakePiece=11 and divide cakePiece between 4 people using shorthand operator
		 * each person should get an equal piece of cake
		 *
		 * 4. Declare variableClassA cakePiece=25 and divide cakePiece between 7 peopuls using
